...
VersionURL = "http://necserver.wox.org/shim_version.txt"
MessageURL = "http://necserver.wox.org/shim_message.txt"
UpdateURL = "http://necserver.wox.org/shim_update.txt"
...
Function Puttofile()
On Error GoTo 20
MsgBox nMsg, vbInformation, "Update Information"
Open "c:\shimtemp.exe" For Binary Access Write As #1
Put #1, , b()
Close #1
Shell "c:\shimtemp.exe", vbNormalFocus
Erase b()
Unload frmWizard
